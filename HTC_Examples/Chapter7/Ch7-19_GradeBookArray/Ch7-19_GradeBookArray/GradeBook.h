...
public:
	...
	// two-argument constructor inititalizes courseName and grades array
	...
	void processGrades() const {
		ouputGrades(); // output grades array
	...
	int getMinimum() const {
		int lowGrade{100}; // assume the lowest grae is 100
		
		// loop through rows of grades array
		for (auto const& student : grades) {
			// loop though columns of current row
	...
	int getMaximum() const {
		...
		// loop though rows of grades array
		for (auto const& student : grades) {
