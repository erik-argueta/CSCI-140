...
public:
	...
	// constructor initializes couseName and grades array
	...
	int getMaximum() const
	{
		...
		for (int grade : grades)
		{
			// if current grade is higher than highGrade, assign it to highGrade
			if (grade > highGrade)
			{
