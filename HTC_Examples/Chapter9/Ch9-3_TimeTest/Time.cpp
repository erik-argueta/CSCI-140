...
#include <iomanip> // for setw and setfill stream manupulators
...
// ostreamstring allows to cout items as strings
// setfill is sticky; will apply to all outputs/couts
...
// return Time as string in standard-time format (HH:MM:SS AM or HH:MM:SS PM)
